import { E as EventEmitter, g as getDefaultExportFromCjs, P as PublicKey, T as Transaction, V as VersionedTransaction } from "./index.js";
        ...
        return __awaiter$3(_this, void 0, void 0, function() {
          ...
          return __generator$3(this, function(_a) {
            switch (_a.label) {
              ...
              case 1:
                response = _a.sent();
                signature = bs58$1.decode(response.signature);
          ...
          switch (_a.label) {
            case 0:
              ...
              return [4, this._sendRequest("signTransactionV2", {
                transaction: bs58$1.encode(transaction)
              })];
            case 1:
              signedTransaction = _a.sent().transaction;
              return [2, bs58$1.decode(signedTransaction)];
          }
        });
      });
    };
      ...
      return __awaiter$1(this, void 0, void 0, function() {
        ...
        return __generator$1(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              result = _b.sent();
              return [2, Uint8Array.from(bs58$1.decode(result))];
            case 3:
              e_4 = _b.sent();
