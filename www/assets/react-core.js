import { C as Connection, W as WalletError, B as BaseWalletAdapter, a as WalletReadyState, b as WalletDisconnectedError, c as WalletDisconnectionError, d as WalletNotConnectedError, S as SolanaSignAndSendTransaction, e as SolanaSignTransaction, f as WalletAccountError, g as WalletConfigError, h as getChainForEndpoint, i as WalletSendTransactionError, j as isVersionedTransaction, k as getCommitment, l as bs58, m as WalletNotReadyError, n as WalletConnectionError, P as PublicKey, o as WalletPublicKeyError, p as SolanaSignMessage, q as SolanaSignIn, V as VersionedTransaction, T as Transaction, r as WalletSignTransactionError, s as WalletSignMessageError, t as WalletSignInError, u as isWalletAdapterCompatibleStandardWallet, v as SolanaMobileWalletAdapterWalletName, w as SolanaMobileWalletAdapter, x as createDefaultWalletNotFoundHandler, y as createDefaultAuthorizationResultCache, z as createDefaultAddressSelector } from "./solana-web3.js";
import { s as schedulerExports, S as StandardEvents, a as StandardDisconnect, b as StandardConnect, c as arraysEqual, D as DEPRECATED_getWallets } from "./vendor-libs.js";
...
const WalletContext = reactExports.createContext(DEFAULT_CONTEXT$1);
function useWallet() {
...
function WalletProviderBase({ children, wallets: adapters, adapter, isUnloadingRef, onAutoConnectRequest, onConnectError, onError, onSelectWallet }) {
  ...
  const [publicKey, setPublicKey] = reactExports.useState(() => (adapter == null ? void 0 : adapter.publicKey) ?? null);
...
const Collapse = ({ id: id2, children, expanded = false }) => {
  ...
  return React.createElement("div", { className: "wallet-adapter-collapse", id: id2, ref, role: "region", style: { height: 0, transition: instant.current ? void 0 : transition } }, children);
};
