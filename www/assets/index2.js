import { g as getDefaultExportFromCjs, S as SolanaSignAndSendTransaction, a as SolanaSignTransaction, b as SolanaSignMessage, E as EventEmitter, P as PublicKey, T as Transaction, V as VersionedTransaction } from "./index.js";
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const response = yield this._sendIframeMessage({
          ...
          params: {
            transaction: bs58$1.encode(serializedTransaction)
          }
        });
        const { transaction: signedTransaction } = response;
        return isLegacyTransactionInstance(transaction) ? Transaction.from(bs58$1.decode(signedTransaction)) : VersionedTransaction.deserialize(bs58$1.decode(signedTransaction));
      } catch (e) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const { transactions: signedTransactions } = yield this._sendIframeMessage({
          ...
          params: {
            transactions: serializedTransactions.map((transaction) => bs58$1.encode(transaction))
          }
        });
        return signedTransactions.map((signedTransaction, index) => {
          return isLegacyTransactionInstance(transactions[index]) ? Transaction.from(bs58$1.decode(signedTransaction)) : VersionedTransaction.deserialize(bs58$1.decode(signedTransaction));
        });
      } catch (e) {
  ...
  signMessage(data, display = "utf8") {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return Uint8Array.from(bs58$1.decode(signature));
      } catch (e) {
  ...
  standardSignAndSendTransaction(...inputs) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (inputs.length === 1) {
        ...
        outputs.push({ signature: bs58$1.decode(signature) });
